...
public class EndpointsAsyncTask extends AsyncTask<Pair<Context, String>, Void, String> {
    ...
    protected void onPostExecute(String result) {
        //Toast.makeText(bcontext, result, Toast.LENGTH_LONG).show();
//        Intent intent = new Intent(bcontext, JokeActivity.class);
//        intent.putExtra(JokeActivity.KEYJOKE, result);
